(function (global, factory) {
    ...
    const echartSetOption = (e, t, a, r) => {
        ...
        e.setOption(merge$2(a(), t)), s((() => {
            e.resize(), r && n(r);
        })), r && n(r), c.addEventListener("clickControl", (({
            detail: {
                control: r
            }
        }) => {
    ...
    const handleNavbarVerticalCollapsed = () => {
        const {
            ...
            setItemToStore: a,
            resize: o
        } = window.phoenix.utils, l = "html", r = "body", n = ".navbar-vertical", c = ".navbar-vertical-toggle", s = ".navbar-vertical .navbar-collapse", i = ".navbar-vertical .nav-link.active", v = "click", d = "mouseover", m = "mouseleave", u = "navbar.vertical.toggle", b = "navbar-vertical-collapsed", h = "navbar-vertical-collapsed-hover", g = document.querySelector(c), p = document.querySelector(l), y = document.querySelector(s), E = document.querySelector(i), L = e("phoenixIsNavbarVerticalCollapsed", !1);
    ...
    const {
        ...
        const {
            getData: e,
            getItemFromStore: t
        } = window.phoenix.utils, o = new DomNode(document.body),
