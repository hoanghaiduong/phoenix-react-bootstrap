...
function CreateRestaurant() {
    ...
    return (
        ...
        <div class="d-flex flex-center content-min-h">
          ...
          :
          <div class="card" style={{marginTop: 120, overflow: 'auto', marginBottom: 20, display: 'flex', flexWrap: 'wrap', justifyContent: 'center', background: 'none', border: 'none', width: '90vw', borderRadius: 8, padding: 20, paddingTop: 40}}>
