...
function CreateRestaurant() {
    ...
    return (
        ...
        <div class="d-flex flex-center content-min-h">
          ...
          :
          <div class="card" style={{marginTop: 120, overflow: 'auto', marginBottom: 20, display: 'flex', flexWrap: 'wrap', justifyContent: 'center', boxShadow: 'rgba(99, 99, 99, 0.2) 0px 2px 8px 0px', width: '90vw', borderRadius: 8, padding: 20, paddingTop: 40}}>
            <div style={{display: 'flex', justifyContent: 'flex-end', width: '98%'}}><Link className="btn btn-lg btn-outline-primary" to='/restaurant/basic-info'>+ Tạo nhà hàng</Link></div>
            {
              listRestaurants.map((restaurant) =>{
                return(
                  <div class="card mb-0" style={{margin: 20, minWidth: '95%'}}>
                  <div class="card-body">
