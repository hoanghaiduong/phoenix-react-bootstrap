...
function NavbarsTopSlim({ styled }) {
    return (
        <nav
            className={`navbar navbar-top navbar-slim justify-content-between fixed-top navbar-expand-lg ${styled === 'darker' ? 'navbar-darker' : ''}`}
            id="navbarTopSlim"
        >
                ...
                >
                    <li className="nav-item dropdown">
                        <a
                            ...
                            aria-expanded="false"
                        >
                            <span className="uil fs-0 me-2 uil-chart-pie" />
                            Home
                        </a>
                    ...
                    <li className="nav-item dropdown">
                        <a
                            ...
                            aria-expanded="false"
                        >
                            <span className="uil fs-0 me-2 uil-cube" />
                            Apps
                        </a>
                        <ul className="dropdown-menu navbar-dropdown-caret">
                            <li className="dropdown">
                                ...
                                >
                                    <div className="dropdown-item-wrapper">
                                        <span className="uil fs-0 uil-angle-right lh-1 dropdown-indicator-icon" />
                                        <span>
                                            <span className="me-2 uil" data-feather="shopping-cart" />E
                                            commerce
                                        </span>
                            ...
                            <li className="dropdown">
                                ...
                                <ul className="dropdown-menu">
                                    ...
                                    <li>
                                        <a className="dropdown-item" href="apps/crm/deal-details.html">
                                            <div className="dropdown-item-wrapper">
                                                <span className="me-2 uil" />
                                                Deal details
                                            </div>
                                    ...
                                    <li>
                                        <a className="dropdown-item" href="apps/crm/lead-details.html">
                                            <div className="dropdown-item-wrapper">
                                                <span className="me-2 uil" />
                                                Lead details
                                            </div>
                                    ...
                                    <li>
                                        <a className="dropdown-item" href="apps/crm/add-contact.html">
                                            <div className="dropdown-item-wrapper">
                                                <span className="me-2 uil" />
                                                Add contact
                                            </div>
                            ...
                            <li className="dropdown">
                                ...
                                <ul className="dropdown-menu">
                                    ...
                                    <li>
                                        <a className="dropdown-item" href="apps/social/settings.html">
                                            <div className="dropdown-item-wrapper">
                                                <span className="me-2 uil" />
                                                Settings
                                            </div>
                    ...
                    <li className="nav-item dropdown">
                        <a
                            ...
                            aria-expanded="false"
                        >
                            <span className="uil fs-0 me-2 uil-files-landscapes-alt" />
                            Pages
                        </a>
                        <ul className="dropdown-menu navbar-dropdown-caret">
                            <li>
                            ...
                            <li className="dropdown">
                                ...
                                <ul className="dropdown-menu">
                                    <li>
                                        <a className="dropdown-item" href="pages/landing/default.html">
                                            <div className="dropdown-item-wrapper">
                                                <span className="me-2 uil" />
                                                Default
                                            </div>
                            ...
                            <li className="dropdown">
                                ...
                                <ul className="dropdown-menu">
                                    <li>
                                        <a className="dropdown-item" href="demo/vertical-sidenav.html">
                                            <div className="dropdown-item-wrapper">
                                                <span className="me-2 uil" />
                                                Vertical sidenav
                                            </div>
                                    ...
                                    <li>
                                        <a className="dropdown-item" href="demo/dark-mode.html">
                                            <div className="dropdown-item-wrapper">
                                                <span className="me-2 uil" />
                                                Dark mode
                                            </div>
                                    ...
                                    <li>
                                        <a className="dropdown-item" href="demo/sidenav-collapse.html">
                                            <div className="dropdown-item-wrapper">
                                                <span className="me-2 uil" />
                                                Sidenav collapse
                                            </div>
                                    ...
                                    <li>
                                        <a className="dropdown-item" href="demo/topnav-slim.html">
                                            <div className="dropdown-item-wrapper">
                                                <span className="me-2 uil" />
                                                Topnav slim
                                            </div>
                                    ...
                                    <li>
                                        <a className="dropdown-item" href="demo/navbar-top-slim.html">
                                            <div className="dropdown-item-wrapper">
                                                <span className="me-2 uil" />
                                                Navbar top slim
                                            </div>
                                    ...
                                    <li>
                                        <a className="dropdown-item" href="demo/navbar-top.html">
                                            <div className="dropdown-item-wrapper">
                                                <span className="me-2 uil" />
                                                Navbar top
                                            </div>
                                    ...
                                    <li>
                                        <a className="dropdown-item" href="demo/horizontal-slim.html">
                                            <div className="dropdown-item-wrapper">
                                                <span className="me-2 uil" />
                                                Horizontal slim
                                            </div>
                                    ...
                                    <li>
                                        <a className="dropdown-item" href="demo/combo-nav.html">
                                            <div className="dropdown-item-wrapper">
                                                <span className="me-2 uil" />
                                                Combo nav
                                            </div>
                                    ...
                                    <li>
                                        <a className="dropdown-item" href="demo/combo-nav-slim.html">
                                            <div className="dropdown-item-wrapper">
                                                <span className="me-2 uil" />
                                                Combo nav slim
                                            </div>
                    ...
                    <li className="nav-item dropdown">
                        <a
                            ...
                            aria-expanded="false"
                        >
                            <span className="uil fs-0 me-2 uil-puzzle-piece" />
                            Modules
                        </a>
                                ...
                                <div className="px-3 pt-4 pb-3 img-dropdown">
                                    <div className="row gx-4 gy-5">
                                        <div className="col-12 col-sm-6 col-md-4">
                                            ...
                                            <a className="dropdown-link" href="modules/forms/wizard.html">
                                                Wizard
                                            </a>
                    ...
                    <li className="nav-item dropdown">
                        <a
                            ...
                            aria-expanded="false"
                        >
                            <span className="uil fs-0 me-2 uil-document-layout-right" />
                            Documentation
                        </a>
                        <ul className="dropdown-menu navbar-dropdown-caret">
                            <li>
                            ...
                            <li>
                                <a className="dropdown-item" href="documentation/design-file.html">
                                    <div className="dropdown-item-wrapper">
                                                ...
                                                <div className="d-flex">
                                                    ...
                                                    <div className="flex-1 me-sm-3">
                                                        ...
                                                        <p className="fs--1 text-1000 mb-2 mb-sm-3 fw-normal">
                                                            <span className="me-1 fs--2">💬</span>Mentioned you in
                                                            a comment.
                                            ...
                                            <div className="d-flex align-items-center justify-content-between position-relative">
                                                <div className="d-flex">
                                                    ...
                                                    <div className="flex-1 me-sm-3">
                                                        ...
                                                        <p className="fs--1 text-1000 mb-2 mb-sm-3 fw-normal">
                                                            <span className="me-1 fs--2">👤</span>Tagged you in a
                                                            comment.
                                                            <span className="ms-2 text-400 fw-bold fs--2" />
                                                        </p>
                                                        <p className="text-800 fs--1 mb-0">
                        ...
                        <div className="card position-relative border-0">
                            ...
                            <div className="overflow-auto scrollbar" style={{ height: "10rem" }}>
                                <ul className="nav d-flex flex-column mb-2 pb-1">
                                    ...
                                    <li className="nav-item">
                                        <a className="nav-link px-3" href="#!">
                                            <span className="me-2 text-900" data-feather="help-circle" />
                                            Help Center
                                        </a>
                                    </li>
                                    <li className="nav-item">
